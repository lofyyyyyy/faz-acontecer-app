...
class CategoriaDecoracoesEvento extends StatelessWidget {
  @override
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => DecoracoesEvento(),
                        ),
                      );
                    },
                    child:  CustomCard(
                      image: AssetImage('assets/images/categorias/categoriaDecoracao1.png'),
                      name: 'Enfeites',
                    ),
                  ),
                  InkWell(
                    ...
                    child:  CustomCard(
                      image: AssetImage('assets/images/categorias/categoriaDecoracao2.png'),
                      name: 'Balões',
                    ),
                  ),
                ],
